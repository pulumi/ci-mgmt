...
export const setupNode = "actions/setup-node@v1";
...
export const automerge = "pascalgn/automerge-action@v0.12.0";
export const addAndCommit = "EndBug/add-and-commit@v4";
