...
for (let provider of providers) {
    ...
    const contexts: string[] = [
        "Update Changelog",
        "prerequisites (3.1.301, 1.17.x, 14.x, 3.7)",
        "test (3.1.301, 1.17.x, dotnet, 14.x, 3.7)",
        "test (3.1.301, 1.17.x, go, 14.x, 3.7)",
        "test (3.1.301, 1.17.x, nodejs, 14.x, 3.7)",
        "test (3.1.301, 1.17.x, python, 14.x, 3.7)",
        "build_sdk (3.1.301, 1.17.x, dotnet, 14.x, 3.7)",
        "build_sdk (3.1.301, 1.17.x, go, 14.x, 3.7)",
        "build_sdk (3.1.301, 1.17.x, nodejs, 14.x, 3.7)",
        "build_sdk (3.1.301, 1.17.x, python, 14.x, 3.7)",
    ];
    ...
    if (providerConfig.lint == null) {
        contexts.push("lint (1.17.x)")
        contexts.push("lint-sdk (1.17.x)")
    } else {
